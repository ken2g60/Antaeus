...
fun ResultRow.toBill(): Bill = Bill(
        id = this[BillScheduleTable.id],
        customerId = this[BillScheduleTable.customerId],
        referenceId = this[BillScheduleTable.referenceId],
        status = this[BillScheduleTable.status],
        paymentLink = this[BillScheduleTable.paymentLink],
        currency = this[BillScheduleTable.currency],
        targetMonth = this[BillScheduleTable.targetMonth],
        datePaid = this[BillScheduleTable.datePaid]
)